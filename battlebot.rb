...
bot = Cinch::Bot.new do
	configure do |c|
		...
		c.nick = "BattleBot"
		c.user = "BattleBot"
		c.realname = "I'mTheCAG"
		c.channels = ["#battlestar"]
		c.sasl.username = "BattleBot"
		c.sasl.password ="1mTh3C@g!"
		c.plugins.plugins = [ Cinch::Plugins::PluginManagement, BSGPlugin ]
		#c.plugins.options[Cinch::Plugins::Identify] {
			# NickServ password is "1mTh3C@g!"
		#	:password => "1mTh3C@g",
		#	:type => :nickserv,
		#}
	end
